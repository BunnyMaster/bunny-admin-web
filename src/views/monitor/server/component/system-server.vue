      ...
      <div class="list-card-item_detail bg-bg_color">
        <el-row justify="space-between">
          ...
          <div class="list-card-item_detail--operation">
            <el-tag
              :color="systemServerInfo?.components?.diskSpace?.status === 'UP' ? '#00a870' : '#eee'"
    ...
    <div :class="cardClass">
      <div class="list-card-item_detail bg-bg_color">
        <el-row justify="space-between">
          ...
          <div class="list-card-item_detail--operation">
            <el-tag
              :color="systemServerInfo?.components?.db?.status === 'UP' ? '#00a870' : '#eee'"
              class="mx-1 list-card-item_detail--operation--tag"
              effect="dark"
            >
        ...
        <el-row justify="space-between">
          ...
          <div class="list-card-item_detail--operation">
            <el-tag
              :color="systemServerInfo?.components?.redis?.status === 'UP' ? '#00a870' : '#eee'"
              class="mx-1 list-card-item_detail--operation--tag"
              effect="dark"
            >
        ...
        <el-text>
          <div>
            Redis状态：{{ systemServerInfo?.components?.redis?.status === 'UP' ? $t('enable') : $t('disable') }}
          </div>
