	...
	<LayPanel>
		<div class="p-5">
			...
			<span v-if="useAppStoreHook().getViewportWidth > 1280">
				...
				<el-input-number v-if="isNumber(settings.stretch)" v-model="settings.stretch as number" :max="1600" :min="1280" controls-position="right" @change="value => setStretch(value)" />
			...
			<ul class="setting">
				<li>
					...
					<el-switch v-model="settings.greyVal" :active-text="t('buttons.pureOpenText')" :inactive-text="t('buttons.pureCloseText')" inline-prompt @change="greyChange" />
				</li>
				<li>
					<span class="dark:text-white">{{ t('panel.pureWeakModel') }}</span>
					<el-switch v-model="settings.weakVal" :active-text="t('buttons.pureOpenText')" :inactive-text="t('buttons.pureCloseText')" inline-prompt @change="weekChange" />
				</li>
				<li>
					<span class="dark:text-white">{{ t('panel.pureHiddenTags') }}</span>
					<el-switch v-model="settings.tabsVal" :active-text="t('buttons.pureOpenText')" :inactive-text="t('buttons.pureCloseText')" inline-prompt @change="tagsChange" />
				</li>
				<li>
					<span class="dark:text-white">{{ t('panel.pureHiddenFooter') }}</span>
					<el-switch v-model="settings.hideFooter" :active-text="t('buttons.pureOpenText')" :inactive-text="t('buttons.pureCloseText')" inline-prompt @change="hideFooterChange" />
				</li>
				<li>
				...
				<li>
					...
					<el-switch v-model="settings.multiTagsCache" :active-text="t('buttons.pureOpenText')" :inactive-text="t('buttons.pureCloseText')" inline-prompt @change="multiTagsCacheChange" />
				</li>
			</ul>
		</div>
	</LayPanel>
